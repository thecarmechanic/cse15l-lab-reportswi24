...
1. **Without any arguments**\
   ...
   ![Image](~/screenshots/cd-no-arg.png)\
   ...
   ![Image](~/screenshots/ls-no-arg.png)\
   ...
   ![Image](~/screenshots/cat-no-arg.png)\
...
2. **With a path to a directory as an argument**\
   ...
   ![Image](~/screenshots/cd-w-directory.png)\
   ...
   ![Image](~/screenshots/ls-w-directory.png)\
   ...
   ![Image](~/screenshots/cat-w-directory.png)\
